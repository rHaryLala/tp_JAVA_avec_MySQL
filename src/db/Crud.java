...
public class Crud {
    ...
    public void ajouter(Connection connection, Scanner scanner) {
        try {
            System.out.print("Entrez le matricule : ");
            int matricule = Integer.parseInt(scanner.nextLine().trim());
            ...
            int salaire = Integer.parseInt(scanner.nextLine().trim());
            ...
            System.out.println("Saisie numerique invalide. Operation annulee.");
        }
    }

    public void modifier(Connection connection, Scanner scanner) {
        try {
            System.out.print("Entrez le matricule : ");
            int matricule = Integer.parseInt(scanner.nextLine().trim());
    ...
    public void supprimer(Connection connection, Scanner scanner) {
        try {
